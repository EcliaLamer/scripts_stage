df_K10 = read.csv("donnees_reg_K10.csv", sep = ";", header = TRUE)
df_K12_5 = read.csv("donnees_reg_K12_5.csv", sep = ";", header = TRUE)
df_K15 = read.csv("donnees_reg_K15.csv", sep = ";", header = TRUE)
df_K17_5 = read.csv("donnees_reg_K17_5.csv", sep = ";", header = TRUE)
df_K20 = read.csv("donnees_reg_K20.csv", sep = ";", header = TRUE)
df_K22_5 = read.csv("donnees_reg_K22_5.csv", sep = ";", header = TRUE)
df_K25 = read.csv("donnees_reg_K25.csv", sep = ";", header = TRUE)
df_K25_sans_out = read.csv("donnees_reg_K25_sans_out.csv", sep = ";", header = TRUE)
names(df_K25)
summary(df_K10)
